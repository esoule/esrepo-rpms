...
Name:		rtems-4.6ng10-powerpc-rtems-gdb
...
Requires:	rtems-4.6ng10-gdb-common
BuildRequires:	%{?suse:makeinfo}%{!?suse:texinfo}

%if "%{gdb_version}" == "7.2"
Source0: ftp://ftp.gnu.org/gnu/gdb/gdb-7.2a.tar.bz2
Patch0: ftp://ftp.rtems.org/pub/rtems/SOURCES/4.10/gdb-7.2-rtems4.10-20100903.diff
%endif
%if "%{gdb_version}" == "7.1"
Source0: ftp://ftp.gnu.org/gnu/gdb/gdb-7.1a.tar.bz2
...
# powerpc-rtems-gdb
# ==============================================================
# %package -n rtems-4.6ng10-powerpc-rtems-gdb
...
%description -n rtems-4.6ng10-powerpc-rtems-gdb
GNU gdb targetting powerpc-rtems.

%files -n rtems-4.6ng10-powerpc-rtems-gdb
...
# ==============================================================
# rtems-4.6ng10-gdb-common
# ==============================================================
%package -n rtems-4.6ng10-gdb-common
...
%description -n rtems-4.6ng10-gdb-common

GDB files shared by all targets.

%post -n rtems-4.6ng10-gdb-common
...
%preun -n rtems-4.6ng10-gdb-common
if [ $1 -eq 0 ]; then
...
%files -n rtems-4.6ng10-gdb-common
%{?el5:%defattr(-,root,root)}
%dir %{_prefix}
%dir %{_prefix}/share
...
%changelog
* Thu Aug 07 2014 Evgueni Souleimanov <esoule@100500.ca> - 7.2-7.1.1
- build gdb 7.2 for rtems-4.6 (rtems-4.6ng10)
