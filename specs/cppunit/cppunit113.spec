...
Source0:        http://dev-www.libreoffice.org/src/cppunit-%{version}.tar.gz
...
developing applications that use cppunit.
...
generated by the popular doxygen documentation generation
tool.
